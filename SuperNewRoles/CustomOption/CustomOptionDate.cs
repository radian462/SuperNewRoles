    ...
    public class CustomOptions
    {
        ...
        public static void Load()
        {
            ...
            */
            ...
            FakekillerOption = new CustomRoleOption(883, false, CustomOptionType.Crewmate, "FakeillerName", RoleClass.Fakeiller.color, 1);
            FakeillerPlayerCount = CustomOption.Create(884, false, CustomOptionType.Crewmate, "FakeillerPlayerCountName", ImpostorPlayers[0], ImpostorPlayers[1], ImpostorPlayers[2], ImpostorPlayers[3], FakeillerOption);
            //表示設定
